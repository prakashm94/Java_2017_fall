...
import userinterface.PharmacyEnterprise.PharmacyEnterpriseAdminWorkAreaJPanel;

/**
 *
 * @author indu
 */
public class PharmaEnterpriseAdminRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, NetworkState sNetwork, NetworkCountry cNetwork, EcoSystem business) {
        return new PharmacyEnterpriseAdminWorkAreaJPanel(userProcessContainer,enterprise);
    }
