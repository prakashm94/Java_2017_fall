...
public class PharmacyManageEmployeeJPanel extends javax.swing.JPanel {
 private OrganizationDirectory organizationDir;
    ...
    public PharmacyManageEmployeeJPanel(JPanel userProcessContainer,OrganizationDirectory organizationDir) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 312, 480, 92));
        ...
        add(addJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 542, 230, 50));
        ...
        add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 272, 130, -1));

        jLabel1.setFont(new java.awt.Font("Dubai Medium", 0, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Manage Pharmacy Employees");
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 292, -1, -1));

        jLabel2.setFont(new java.awt.Font("Dubai Medium", 0, 14)); // NOI18N
        jLabel2.setText("Name");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 492, -1, -1));

        nameJTextField.setFont(new java.awt.Font("Dubai Medium", 0, 14)); // NOI18N
        add(nameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 492, 126, -1));

        organizationEmpJComboBox.setFont(new java.awt.Font("Dubai Medium", 0, 14)); // NOI18N
        organizationEmpJComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(organizationEmpJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 452, 120, -1));

        jLabel3.setFont(new java.awt.Font("Dubai Medium", 0, 14)); // NOI18N
        jLabel3.setText("Organization");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 452, -1, -1));

        updateBtn.setBackground(new java.awt.Color(36, 47, 65));
        updateBtn.setFont(new java.awt.Font("Dubai Medium", 0, 13)); // NOI18N
        ...
        add(updateBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 700, 240, 60));

        deleteBtn.setBackground(new java.awt.Color(36, 47, 65));
        deleteBtn.setFont(new java.awt.Font("Dubai Medium", 0, 13)); // NOI18N
        ...
        add(deleteBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 610, 240, 60));
        ...
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 270, -1, -1));
...
public void populateOrganizationComboBox(){
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "No organizations available!!");
            return;
        }
