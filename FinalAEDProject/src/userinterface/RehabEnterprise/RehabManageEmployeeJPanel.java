 ...
 */
public class RehabManageEmployeeJPanel extends javax.swing.JPanel {
 private OrganizationDirectory organizationDir;
    ...
    public RehabManageEmployeeJPanel(JPanel userProcessContainer,OrganizationDirectory organizationDir) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 301, 480, 92));
        ...
        add(addJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 531, 230, 50));
        ...
        add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 261, 130, -1));

        jLabel1.setFont(new java.awt.Font("Dubai Medium", 0, 14)); // NOI18N
        jLabel1.setText("Organization");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 261, -1, -1));
        ...
        add(backJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 281, -1, -1));

        jLabel2.setFont(new java.awt.Font("Dubai Medium", 0, 14)); // NOI18N
        jLabel2.setText("Name");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 481, -1, -1));
        ...
        add(nameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 481, 120, -1));

        organizationEmpJComboBox.setFont(new java.awt.Font("Dubai Medium", 0, 14)); // NOI18N
        organizationEmpJComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(organizationEmpJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 441, 120, -1));

        jLabel3.setFont(new java.awt.Font("Dubai Medium", 0, 14)); // NOI18N
        jLabel3.setText("Organization");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 441, -1, -1));
        ...
        add(deleteBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 540, 210, 40));
        ...
        add(updateBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 530, 170, 50));

        jLabel4.setFont(new java.awt.Font("Dubai Medium", 0, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Manage Rehab Enterprise Employees");
...
public void populateOrganizationComboBox(){
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        else if(organizationEmpJComboBox.getSelectedItem()==null)
        {
            JOptionPane.showMessageDialog(null,"No organizations exist");
        }
            ...
            {
                if(e.getName().equals(nameJTextField.getText()))
                {
                    JOptionPane.showMessageDialog(null, "Employee exists already");
                    return;
                }
            }
